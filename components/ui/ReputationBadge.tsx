...
export default function ReputationBadge({ score, loading }: ReputationBadgeProps) {
  if (loading) {
    return (
      <div className="flex items-center gap-2 card py-2 px-4 animate-pulse">
        <div className="w-16 h-4 bg-dark-muted rounded" />
      </div>
    );
  }
  ...
  return (
    <div className={`flex items-center gap-3 card py-2 px-4 border ${tierColors[score.tier]}`}>
